<x-app-layout>
    <x-slot:title>Dashboard</x-slot>
        <div class="max-w-4xl mx-auto mt-8 space-y-6">
            ...
            {{-- Header Profil --}}
            <div class="flex justify-between items-center bg-white border border-gray-200 rounded-xl p-4 transition-colors duration-300">
                {{-- Kiri: Avatar + Nama --}}
            ...
            {{-- Greeting --}}
            <p class="text-[#4c6647] font-medium">
            ...
            <div class="border border-yellow-300 bg-yellow-50 text-yellow-800 rounded-xl p-4">
                <div class="font-semibold mb-1">⏳ Hak Cuti Belum Aktif</div>
                <p class="text-sm">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div class="text-center p-4 rounded-xl border border-gray-200 bg-white shadow-sm transition-colors">
                    <p class="text-2xl font-bold text-[#4c6647]">{{ $item['value'] }}</p>
            ...
            {{-- Riwayat Pengajuan --}}
            <div class="rounded-xl overflow-hidden border border-gray-200 bg-white transition-colors duration-300">
                <div class="px-4 py-2 font-semibold bg-gray-50 border-b border-gray-200 text-gray-800">
                ...
                <table class="min-w-full text-sm text-left text-gray-700">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t border-gray-200 hover:bg-[#9dcd5a]/10 transition">
                            ...
                            <td class="px-4 py-2 text-gray-600">
                                <a href="{{ route('karyawan.cuti.index') }}" class="text-[#6da54e] hover:text-[#3eb20e] font-semibold">
                                    Lihat
                                </a>
                            </td>
                        </tr>
