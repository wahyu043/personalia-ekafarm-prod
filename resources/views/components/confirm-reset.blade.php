...
<div x-data="{ open: false }" class="inline-block">
    <button type="button"
        ...
        class="inline-block px-3 py-1 text-sm font-semibold rounded-md
               ...
               bg-yellow-100/40 hover:bg-yellow-500 hover:text-white transition">
        Reset
    </button>
        ...
        <div @click.away="open = false" x-transition.scale
            ...
            <div class="flex justify-center gap-3">
                ...
                <button type="button"
                    ...
                    class="px-4 py-2 rounded-md bg-yellow-500 text-white font-semibold hover:bg-yellow-400 transition">
                    {{ $confirm }}
                </button>
            </div>
        </div>
